...
public class MonitorSportellii{
     ...
     */
    public String collegaSportello(int numeroSportello,IdServizio idServizio){
        ...
        getSportello(numeroSportello).setServizioOfferto(ListaServizi.getInstance().getServizio(idServizio));

        return "sportello numero "+numeroSportello+" collegato";
